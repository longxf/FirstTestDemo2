...
public class MySimpleView2 extends View {
    Rect mBounds;
    int padding = 100;

    public MySimpleView2(Context context) {
        super(context);
    }

    public MySimpleView2(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs, 0);
    }

    public MySimpleView2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
